                                ...
                                switch (choose)
                                {
                                    ...
                                    case 1:
                                        ...
                                        {                                           
                                            ...
                                            {
                                                msg += $" Пытаясь вас защитить, погибли все ({pDef}) ваши \U0001f479.";
                                                choose = 8;
                                            }
                                            else
                                            {
                                                msg += $" Ваша база выстояла. Погибло {deadPeople} из {pDef} защитников.";
                                                cod = 0;
